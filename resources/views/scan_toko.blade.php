...
<div class="card">
    <div class="card-body">
        <h1 align="center">SCAN DATA TOKO </h1>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
                <main class="wrapper" style="padding-top:2em">
                    <section class="container" id="demo-content">
                        ...
                        <div>
                            <a class="btn btn-success btn-lg" id="startButton">Start</a>
                            <a class="btn btn-danger btn-lg" id="resetButton">Reset</a>
                        </div>
                                <br>
                            </section>
                        </main>
...
function getDataLocation($barcode){
                var id_toko = $barcode;
                $.ajax({
                    url: "{{ url('/scan_toko/getLocationToko') }}",
                    type: "POST",
                    data: {
                        idtoko: id_toko,
                        _token: '{{csrf_token()}}'
